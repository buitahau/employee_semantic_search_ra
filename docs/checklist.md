...
[Detail](implementation_plan/tasks/aggregation_exact_filter_revalidation.md)

- ⏳ [Implement BM25 search](implementation_plan/tasks/BM25-search.md)
- ⏳ [Aggregate BM25 results and Semantic results from pgvector](implementation_plan/tasks/Aggregate-BM25-and-semantic.md)
- 📋 Implement exact filter

## Search Quality Validation

Goal: verify that the search pipeline returns relevant, correctly ranked results across realistic employee data.

- 🛠️ [Prepare seed data that is more complex and realistic, with additional test cases and data variations.](implementation_plan/tasks/SQV1-seed-data.md)
- 🛠️ [Create a list of prompts and their expected results based on the seed data.](implementation_plan/tasks/SQV2-test-prompts.md)
- 🛠️ [Implement the tests, collect the actual results, and generate a comparison report against the expected results.](implementation_plan/tasks/SQV3-search-report.md)
